...
import DealsColumn from '../components/deals/column';
...
class TaskDeals extends React.Component {
	static propTypes = {
...
const connected = connect(mapStateToProps, mapDispatchToProps)(TaskDeals);
